...
//        String url = "https://free.currconv.com/api/v7/convert?q=" + convert_from_value + "_" + convert_to_value + "&compact=ultra&apiKey=1498408f1536e92250ee";
        String url = "https://api.freecurrencyapi.com/v1/latest?apikey=sgiPfh4j3aXFR3l2CnjWqdKQzxpqGn9pX5b3CUsz&base_currency=" + convert_from_value + "&currencies=" + convert_to_value;
        ...
        StringRequest stringrequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Double conversion_rate_value = jsonobject.getJSONObject("data").getDouble(convert_to_value);
